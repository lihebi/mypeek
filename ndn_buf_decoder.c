...
/*
 * 输入: msg: 实际interest字符串
 * 输出: interest: parse过的interest
 */
int
...
/*
 * 输入: msg: ContentObject字符串.
 * 输出: x: ndn_parse_ContentObject
 *
 */
int
