...
/**
 * 建立一个unix域名一样的socket地址,用来访问ndnd
 * 如果环境变量NDN_DEFAULT_LOCAL_SOCKNAME 被设置了,那么提供名字stem.否则使用默认
 * 即: /tmp/.ndnd.sock
 * 如果 portstr 是空的,使用环境变量 NDN_LOCAL_PORT.
 * result是返回的 unix domain sockaddr
 *
 ...
 * 建立socket address
 *
 * name字符串"tcp[4|6][:port]"
 * default NDN_LOCAL_PORT
 *
